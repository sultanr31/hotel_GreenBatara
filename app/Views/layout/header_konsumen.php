...
<head>
    ...
    <title>Dashboard - Konsumen Hotel Green Batara</title>
...
<body>
    ...
    <div class="sidebar-header position-relative">
        <div class="d-flex justify-content-between align-items-center">
            <div class="logo">
                <a href="/dashboardKonsumen/"><img src="https://cdn.discordapp.com/attachments/795473402617135194/1034376602995396639/GreemBatara.png" alt="Logo" srcset="">Hotel</a>
            </div>
    ...
    <div class="sidebar-menu">
        <ul class="menu">
            ...
            <li
                ...
                <a href="/dashboardKonsumen/" class='sidebar-link'>
            ...
            <li
                class="sidebar-item  ">
                <a href="/reservasi_konsumen/" class='sidebar-link'>
