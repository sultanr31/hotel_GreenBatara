        ...
        <div class="container">
            <div class="row content-wrapper justify-content-center">
                <div class="col-lg-3 offset-lg-1 mbr-form" data-form-type="formoid">
                    <form action="/auth_konsumen/" method="POST" class="mbr-form form-with-styler" data-form-title="Form Name"><input type="hidden" name="email" data-form-email="true" value="I07EVP1KA1umHCAl8S4q+zSbS9imY2Spgdy7XFT9nh8WLfttIiu6opZTi25PySqvproac43CtHGSl2f7JHzQk0YQGiKtR3pyFxpFNUUEZSPxRYeBBhGGq0AMAZrF+vJ4">
                        <div class="row">
                            <div hidden="hidden" data-form-alert="" class="alert alert-success col-12">Logged in</div>
                        ...
                        <div class="dragArea row">
                            ...
                            <div class="col-lg-12 col-md col-12 form-group mb-3" data-for="gmail">
                                <input type="email" placeholder="E-Mail" data-form-field="gmail" class="form-control form-control-xl" required name="email">
                            </div>
                            <div class="col-lg-12 col-md col-12 form-group mb-3" data-for="pw">
                                <input type="password" placeholder="Password" data-form-field="pw" class="form-control form-control-xl" required name="pass_konsumen">
                            </div>
                            <div>
                                <!-- ?php if (isset($error)): ?>
                                    <p style="color: red; font-style: italic">Mohon cek kembali email/password anda!</p>
                                ?php endif; ?> -->
                            </div>
                ...
                <div class="col-lg-7 offset-lg-1 col-12">
                    ...
                    <img style="max-width: 250px;" src="https://previews.123rf.com/images/grapestock/grapestock1507/grapestock150700028/43230688-green-city-building-save-earth-concept-vector-illustration.jpg" alt=" ">
                    </div>
                </div>
            </div>
        </div>
