...
<body class="bg-gradient-primary" style="background: linear-gradient(#136c16d9, #104e16 99%), url(&quot;https://c4.wallpaperflare.com/wallpaper/971/27/637/beach-bungalow-view-out-in-the-maldives-wallpaper-preview.jpg&quot;), #136c16d9;">
    <div class="container" style="height: 475.547px;padding-top: 43px;">
        <div class="card shadow-lg o-hidden border-0 my-5">
            <div class="card-body p-0">
                <div class="row">
                    <div class="col-lg-5 d-none d-lg-flex">
                        <div class="flex-grow-1 bg-register-image" style="background-image: url(&quot;/assets3/img/dogs/image2.jpeg&quot;);"></div>
                    </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h4 class="text-dark mb-4"><strong>Silahkan Buat Akun!</strong></h4>
                            </div>
                            <form class="user">
                                <div class="row mb-3">
                                ...
                                </div><button class="btn btn-primary d-block btn-user w-100" data-bss-hover-animate="bounce" type="submit">Register Account</button>
                                <hr>
                                <hr>
                            </form>
                            <div class="text-center"></div>
                            <div class="text-center"><a class="small" href="/konsumenIndex">Sudah punya akun? Login!</a></div>
                        </div>
                    </div>
                </div>
            </div>
